...
final class FormerInputAccessoryView: UIToolbar {
    ...
    private struct Style {
        let inputBarTintColor: UIColor
        let inputTintColor: UIColor
        
        static let light = Style(
            inputBarTintColor: inputAccessoryBackgroundColor,
            inputTintColor: inputAccessoryTintColor
        )
        
        static let dark = Style(
            inputBarTintColor: inputAccessoryBackgroundColorDark,
            inputTintColor: inputAccessoryTintColorDark
        )
    }
    ...
    private func apply(_ style: Style) {
        barTintColor = style.inputBarTintColor
        tintColor = style.inputTintColor
    }
}

extension FormerInputAccessoryView: GagatStyleable {
