...
- (void)initUIsize
{
    ...
    [bottomView setBackgroundColor:[UIColor colorWithWhite:1.f alpha:1]];
    ...
    if (!disappearButton) {
        ...
        [disappearButton setTintColor:[UIColor whiteColor]];
        [disappearButton setTitle:@"Cancel" forState:UIControlStateNormal];
        [disappearButton.titleLabel setFont:[UIFont boldSystemFontOfSize:15]];
    ...
    [disappearButton setBackgroundImage: [self imageWithColor:[UIColor redColor]] forState:UIControlStateNormal];
    [disappearButton addTarget:self  action:@selector(closeMenu) forControlEvents:UIControlEventTouchUpInside];
    //CGFloat CANCELw = 28;
    disappearButton.bounds = CGRectMake(0, 0, bottomView.frame.size.width, bottomView.frame.size.height);
